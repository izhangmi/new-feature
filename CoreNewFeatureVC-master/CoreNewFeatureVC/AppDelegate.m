...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if(canShow){
        ...
        NewFeatureModel *m5 = [NewFeatureModel model:[UIImage imageNamed:@"f5"]];
        
        
        window.rootViewController = [CoreNewFeatureVC newFeatureVCWithModels:@[m1,m2,m3,m4,m5] enterBlock:^{
